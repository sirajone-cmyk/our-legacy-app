...
git commit -m "content: add Lesson 4 Companion - Halimah al-Sadiyyah and the Desert Years"
git push origin main
Write-Host "Pushed to GitHub" -ForegroundColor Green

Write-Host ""
Write-Host "=== ALL DONE ===" -ForegroundColor Green
Write-Host "Lesson 4 Companion is live at sirajone-786.web.app" -ForegroundColor Green
Write-Host "Verify: Read Lesson 4 to the Reflection page. Companion CTA should appear." -ForegroundColor Yellow
Write-Host "Verify: Open Companion. Check Memory Gem, Key Facts, Family Discussion, Auth Notes." -ForegroundColor Yellow
